    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ Route::is('booking.index') ? 'active' : '' }} " href="{{ route('booking.index') }}">
                        <span class="nav-icon ml-2">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ Route::is('dokter.index') ? 'active' : '' }}" href="{{ route('dokter.index') }}">
                        <span class="nav-icon ml-2">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ Route::is('jadwal.index') ? 'active' : '' }}" href="{{ route('jadwal.index') }}">
                        <span class="nav-icon ml-2">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ Route::is('unggulan.index') ? 'active' : '' }}" href="{{ route('unggulan.index') }}">
                        <span class="nav-icon ml-2">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ Route::is('profil.index') ? 'active' : '' }}" href="{{ route('profil.index') }}">
                        <span class="nav-icon ml-2">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ Route::is('pelayanan.index') ? 'active' : '' }}" href="{{ route('pelayanan.index') }}">
                        <span class="nav-icon ml-2">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ Route::is('promotion.index') ? 'active' : '' }} " href="{{ route('promotion.index') }}">
                        <span class="nav-icon ml-2">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ Route::is('fasilitasUnggulan.index') ? 'active' : '' }}" href="{{ route('fasilitasUnggulan.index') }}">
                        <span class="nav-icon ml-2">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ Route::is('kritikSaran.index') ? 'active' : '' }} " href="{{ route('kritikSaran.index') }}">
                        <span class="nav-icon ml-2">
