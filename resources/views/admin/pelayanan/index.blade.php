    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <h1 class="app-page-title">Pelayanan</h1>
                            ...
                            <tbody>
                                @foreach ($pelayanans as $pelayanan)
                                    <tr>
                                        ...
                                        <td><img src="{{ $pelayanan->image1 && file_exists(public_path('storage/pelayanan/' . $pelayanan->image1)) ? asset('storage/pelayanan/' . $pelayanan->image1) : asset('images/preview.png') }}"
                                                alt="Gambar pelayanan" style="max-width: 100px; height: auto;"></td>
                                        <td><img src="{{ $pelayanan->image2 && file_exists(public_path('storage/pelayanan/' . $pelayanan->image2)) ? asset('storage/pelayanan/' . $pelayanan->image2) : asset('images/preview.png') }}"
                                                alt="Gambar pelayanan" style="max-width: 100px; height: auto;"></td>
                                        <td><img src="{{ $pelayanan->image3 && file_exists(public_path('storage/pelayanan/' . $pelayanan->image3)) ? asset('storage/pelayanan/' . $pelayanan->image3) : asset('images/preview.png') }}"
                                                alt="Gambar pelayanan" style="max-width: 100px; height: auto;"></td>
                                        <td><img src="{{ $pelayanan->image4 && file_exists(public_path('storage/pelayanan/' . $pelayanan->image4)) ? asset('storage/pelayanan/' . $pelayanan->image4) : asset('images/preview.png') }}"
                                                alt="Gambar pelayanan" style="max-width: 100px; height: auto;"></td>
                                        <td><img src="{{ $pelayanan->image5 && file_exists(public_path('storage/pelayanan/' . $pelayanan->image5)) ? asset('storage/pelayanan/' . $pelayanan->image5) : asset('images/preview.png') }}"
                                                alt="Gambar pelayanan" style="max-width: 100px; height: auto;"></td>
                                        ...
                                        <td>
                                            <form action="{{ Route('pelayanan.destroy', $pelayanan->id) }}" method="post">
                                                ...
                                                <button type="button" class="btn btn-warning text-white btn-edit"
                                                    ...
                                                    data-id="{{ $pelayanan->id }}" data-name="{{ $pelayanan->name }}"
                                                    data-deskripsi="{{ $pelayanan->deskripsi }}"
                                                    data-gambar1="{{ $pelayanan->image1 }}"
                                                    data-gambar2="{{ $pelayanan->image2 }}"
                                                    data-gambar3="{{ $pelayanan->image3 }}"
                                                    data-gambar4="{{ $pelayanan->image4 }}"
                                                    data-gambar5="{{ $pelayanan->image5 }}">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="formTambah" action="{{ Route('pelayanan.store') }}" method="post"
...
@section('script')
    <script>
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            $('#gambar1PreviewEdit').attr('src', "{{ asset('storage/pelayanan/') }}/" + gambar1);
            $('#gambar2PreviewEdit').attr('src', "{{ asset('storage/pelayanan/') }}/" + gambar2);
            $('#gambar3PreviewEdit').attr('src', "{{ asset('storage/pelayanan/') }}/" + gambar3);
            $('#gambar4PreviewEdit').attr('src', "{{ asset('storage/pelayanan/') }}/" + gambar4);
            $('#gambar5PreviewEdit').attr('src', "{{ asset('storage/pelayanan/') }}/" + gambar5);
            $('#formEdit').attr('action', '{{ url('pelayanan') }}/' + id);
        })
