                            ...
                            <tbody>
                                @foreach ($polikliniks as $poliklinik)
                                    <tr>
                                        ...
                                        <td><img src="{{ $poliklinik->image1 && file_exists(public_path('storage/poliklinik/' . $poliklinik->image1)) ? asset('storage/poliklinik/' . $poliklinik->image1) : asset('images/preview.png') }}"
                                                alt="Gambar poliklinik" style="max-width: 100px; height: auto;"></td>
                                        <td><img src="{{ $poliklinik->image2 && file_exists(public_path('storage/poliklinik/' . $poliklinik->image2)) ? asset('storage/poliklinik/' . $poliklinik->image2) : asset('images/preview.png') }}"
                                                alt="Gambar poliklinik" style="max-width: 100px; height: auto;"></td>
                                        <td><img src="{{ $poliklinik->image3 && file_exists(public_path('storage/poliklinik/' . $poliklinik->image3)) ? asset('storage/poliklinik/' . $poliklinik->image3) : asset('images/preview.png') }}"
                                                alt="Gambar poliklinik" style="max-width: 100px; height: auto;"></td>
                                        <td><img src="{{ $poliklinik->image4 && file_exists(public_path('storage/poliklinik/' . $poliklinik->image4)) ? asset('storage/poliklinik/' . $poliklinik->image4) : asset('images/preview.png') }}"
                                                alt="Gambar poliklinik" style="max-width: 100px; height: auto;"></td>
                                        <td><img src="{{ $poliklinik->image5 && file_exists(public_path('storage/poliklinik/' . $poliklinik->image5)) ? asset('storage/poliklinik/' . $poliklinik->image5) : asset('images/preview.png') }}"
                                                alt="Gambar poliklinik" style="max-width: 100px; height: auto;"></td>
                                        ...
                                        <td>
                                            <form action="{{ Route('poliklinik.destroy', $poliklinik->id) }}"
                                                ...
                                                <button type="button" class="btn btn-warning text-white btn-edit"
                                                    ...
                                                    data-gambar2="{{ $poliklinik->image2 }}"
                                                    data-gambar3="{{ $poliklinik->image3 }}"
                                                    data-gambar4="{{ $poliklinik->image4 }}"
                                                    data-gambar5="{{ $poliklinik->image5 }}">
...
@section('script')
    <script>
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            $('#gambar1PreviewEdit').attr('src', "{{ asset('storage/poliklinik/') }}/" + gambar1);
            $('#gambar2PreviewEdit').attr('src', "{{ asset('storage/poliklinik/') }}/" + gambar2);
            $('#gambar3PreviewEdit').attr('src', "{{ asset('storage/poliklinik/') }}/" + gambar3);
            $('#gambar4PreviewEdit').attr('src', "{{ asset('storage/poliklinik/') }}/" + gambar4);
            $('#gambar5PreviewEdit').attr('src', "{{ asset('storage/poliklinik/') }}/" + gambar5);
