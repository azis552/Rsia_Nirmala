        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2 bg-white rounded-2xl shadow-lg p-6 space-y-6">
                <div class="w-full aspect-video overflow-hidden rounded-xl">
                    <img src="{{ asset('storage/pelayanan/' . $pelayanan->image1) }}" alt="Gambar Artikel"
                ...
                <div class="space-y-2">
                    ...
                    <h1 class="text-3xl font-bold text-green-700">{{ $pelayanan->name }}</h1>
                    <hr>
                    <p class="text-gray-700 text-sm">{{ $pelayanan->created_at->format('d F Y') }}</p>
